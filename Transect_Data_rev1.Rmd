...
#transectPlotmean #display table
...
#plot
# calc average  bleaching rate/month in %  per grouping
transectPlotmeanprev <- ddply(rData3, c("Species", "Reef"), summarise, 
...
anova(WhiteMod, type=2)
  ...
  #conduct Tukey post hoc test 
    ...
    cld(emm)
    pairs(emm)
   # Inner,Mcap,0 - Inner,Pcomp,0    p= <.0001
    #Outer,Mcap,0 - Outer,Pcomp,0    p= 1.0000
```
