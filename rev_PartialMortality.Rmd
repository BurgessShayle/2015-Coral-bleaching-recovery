...
#letter display
pairs(emm)
 #4,Month0 - 13,Month0         0.584 4.10 159   0.142 1.0000
#4,Month1.5 - 13,Month1.5    10.725 4.15 165   2.583 0.4179 
#4,Month3 - 13,Month3        20.383 4.16 167   4.894 0.0003 
#4,Month4.5 - 13,Month4.5    25.048 4.27 181   5.865 <.0001
#4,Month6 - 13,Month6        29.872 4.36 193   6.854 <.0001
#4,Month10 - 13,Month10      35.466 4.61 229   7.701 <.0001 
#4,Month18 - 13,Month18      36.714 4.94 279   7.439 <.0001 
#4,Month24 - 13,Month24      36.645 5.01 290   7.312 <.0001
...
#letter display
pairs(emm)
#4,Month0 - 13,Month0       -3.5714 3.36 137 -1.064  0.9995
#4,Month1.5 - 13,Month1.5   -7.1429 3.36 137 -2.127  0.7444 
#4,Month3 - 13,Month3       -6.2143 3.36 137 -1.851  0.8928
#4,Month4.5 - 13,Month4.5   -0.2330 3.37 139 -0.069  1.0000 
#4,Month6 - 13,Month6        2.2651 3.37 139  0.672  1.0000 
#4,Month10 - 13,Month10      5.1680 3.40 142  1.522  0.9782 
#4,Month18 - 13,Month18      9.2781 3.43 148  2.704  0.3385 
#4,Month24 - 13,Month24     10.4339 3.76 202  2.778  0.2904
...
```{r}
#Mcap
gMcap_mort_mod<-glmer(Score~Site*B2015*month+(1|TagID), family = gaussian, Mcap_mort)
Anova(gMcap_mort_mod)

#conduct Tukey post hoc test 
emm = emmeans(gMcap_mort_mod, ~ Site*B2015*month, adjust="tukey")
#letter display
cld(emm)
 
#Pcomp
gPcomp_mort_mod<-lmer(Score~Site*B2015*month+(1|TagID), family = gaussian, Pcomp_mort)
Anova(Pcomp_mort_mod)

#conduct Tukey post hoc test 
emm = emmeans(gPcomp_mort_mod, ~ Site*B2015*month, adjust="tukey")
#letter display
cld(emm)
```


#Tissue Loss  Models  by month
...
```{r}
#Month0 
gMcap_m0<-subset(Mcap_mort, month=="Month0")
gMcap_m0_mod1<-glm(score~Site*B2015, family=gaussian, gMcap_m0)
summary(gMcap_m0_mod1) 
Anova(gMcap_m0_mod1)

# Month1.5
gMcap_m1_5<-subset(Mcap_mort, month=="Month1.5")
gMcap_m1_5_mod1<-glm(score~Site*B2015, family=gaussian, gMcap_m1_5)
summary(gMcap_m1_5_mod1)
Anova(gMcap_m1_5_mod1)
    #conduct Tukey post hoc test 
    emm = emmeans(gMcap_m1_5_mod1, ~ B2015, adjust="tukey")
    #letter display
    cld(emm)

#Month3
gMcap_m3<-subset(Mcap_mort, month=="Month3")
gMcap_m3_mod1<-glm(score~Site*B2015,family=gaussian, gMcap_m3)
summary(gMcap_m3_mod1)
Anova(gMcap_m3_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m3_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m3_mod1, ~ Site*B2015, adjust="tukey")  #B2015*Site
      #letter display
      cld(emm)

#Month4.5
gMcap_m4_5<-subset(Mcap_mort, month=="Month4.5")
gMcap_m4_5_mod1<-glm(score~Site*B2015, family=gaussian,gMcap_m4_5)
summary(gMcap_m4_5_mod1)
Anova(gMcap_m4_5_mod1)
 #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m4_5_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m4_5_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month6
gMcap_m6<-subset(Mcap_mort, month=="Month6")
gMcap_m6_mod1<-glm(score~Site*B2015, family=gaussian,gMcap_m6)
summary(gMcap_m6_mod1)
Anova(gMcap_m6_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m6_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m6_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month10
gMcap_m10<-subset(Mcap_mort, month=="Month10")
gMcap_m10_mod1<-glm(score~Site*B2015,family=gaussian, gMcap_m10)
summary(gMcap_m10_mod1)
Anova(gMcap_m10_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m10_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m10_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month18
gMcap_m18<-subset(Mcap_mort, month=="Month18")
gMcap_m18_mod1<-glm(score~Site*B2015, family=gaussian,gMcap_m18)
summary(gMcap_m18_mod1)
Anova(gMcap_m18_mod1)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m18_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month24
gMcap_m24<-subset(Mcap_mort, month=="Month24")
gMcap_m24_mod1<-glm(score~Site*B2015, family=gaussian,gMcap_m24)
summary(gMcap_m24_mod1)
Anova(gMcap_m24_mod1)
      #conduct Tukey post hoc test 
      emm = emmeans(gMcap_m24_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
```
...
```{r}
#Month0 
gPcomp_m0<-subset(Pcomp_mort, month=="Month0")
gPcomp_m0_mod1<-glm(score~Site*B2015, family=gaussian, gPcomp_m0)
summary(gPcomp_m0_mod1) 
Anova(gPcomp_m0_mod1)

# Month1.5
gPcomp_m1_5<-subset(Pcomp_mort, month=="Month1.5")
gPcomp_m1_5_mod1<-glm(score~Site*B2015, family=gaussian, gPcomp_m1_5)
summary(gPcomp_m1_5_mod1)
Anova(gPcomp_m1_5_mod1)
    #conduct Tukey post hoc test 
    emm = emmeans(gPcomp_m1_5_mod1, ~ B2015, adjust="tukey")
    #letter display
    cld(emm)

#Month3
gPcomp_m3<-subset(Pcomp_mort, month=="Month3")
gPcomp_m3_mod1<-glm(score~Site*B2015,family=gaussian, gPcomp_m3)
summary(gPcomp_m3_mod1)
Anova(gPcomp_m3_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m3_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m3_mod1, ~ Site*B2015, adjust="tukey")  #B2015*Site
      #letter display
      cld(emm)

#Month4.5
gPcomp_m4_5<-subset(Pcomp_mort, month=="Month4.5")
gPcomp_m4_5_mod1<-glm(score~Site*B2015, family=gaussian,gPcomp_m4_5)
summary(gPcomp_m4_5_mod1)
Anova(gPcomp_m4_5_mod1)
 #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m4_5_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m4_5_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month6
gPcomp_m6<-subset(Pcomp_mort, month=="Month6")
gPcomp_m6_mod1<-glm(score~Site*B2015, family=gaussian,gPcomp_m6)
summary(gPcomp_m6_mod1)
Anova(gPcomp_m6_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m6_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m6_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month10
gPcomp_m10<-subset(Pcomp_mort, month=="Month10")
gPcomp_m10_mod1<-glm(score~Site*B2015,family=gaussian, gPcomp_m10)
summary(gPcomp_m10_mod1)
Anova(gPcomp_m10_mod1)
  #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m10_mod1, ~ B2015, adjust="tukey") #B2015
      #letter display
      cld(emm)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m10_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month18
gPcomp_m18<-subset(Pcomp_mort, month=="Month18")
gPcomp_m18_mod1<-glm(score~Site*B2015, family=gaussian,gPcomp_m18)
summary(gPcomp_m18_mod1)
Anova(gPcomp_m18_mod1)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m18_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
      
#Month24
gPcomp_m24<-subset(Pcomp_mort, month=="Month24")
gPcomp_m24_mod1<-glm(score~Site*B2015, family=gaussian,gPcomp_m24)
summary(gPcomp_m24_mod1)
Anova(gPcomp_m24_mod1)
      #conduct Tukey post hoc test 
      emm = emmeans(gPcomp_m24_mod1, ~ Site, adjust="tukey")  #Site
      #letter display
      cld(emm)
```
...
```{r}
#0-3 months
gMcap_m03rate<-glmer(Rate~Site*B2015+(1|Pair), family=gaussian, Mcap_rate_03)
summary(gMcap_m03rate)
Anova(gMcap_m03rate)
 #conduct Tukey post hoc test 
    emm = emmeans(gMcap_m03rate, ~ B2015, adjust="tukey")
    #letter display
    cld(emm)
    emm = emmeans(gMcap_m03rate, ~ Site, adjust="tukey")
    #letter display
    cld(emm)
    emm = emmeans(Mcap_m03rate, ~ B2015*Site, adjust="tukey")
    #letter display
...
#3-6 months
gMcap_m36rate<-glmer(Rate~Site*B2015+(1|Pair), family = gaussian, Mcap_rate_36)
summary(gMcap_m36rate)
Anova(gMcap_m36rate)
 #conduct Tukey post hoc test 
    emm = emmeans(gMcap_m36rate, ~ Site, adjust="tukey")
    #letter display
    cld(emm)
...
```{r}
#0-3 months
gPcomp_m03rate<-glmer(Rate~Site*B2015+(1|Pair), family=gaussian, Pcomp_rate_03)
summary(gPcomp_m03rate)
Anova(gPcomp_m03rate)
 #conduct Tukey post hoc test 
    emm = emmeans(gPcomp_m03rate, ~ B2015, adjust="tukey")
    #letter display
    cld(emm)

#3-6 months
gPcomp_m36rate<-glmer(Rate~Site*B2015+(1|Pair), family = gaussian, Pcomp_rate_36)
summary(gPcomp_m36rate)
Anova(gPcomp_m36rate)
 #conduct Tukey post hoc test 
    emm = emmeans(gPcomp_m36rate, ~ Site, adjust="tukey")
    #letter display
    cld(emm)
    emm = emmeans(gPcomp_m36rate, ~ Site*B2015, adjust="tukey")
    #letter display
    cld(emm)
