...
#Figure 5
Color score df setup, means, and individual plots:
```{r, results="hide", message=FALSE} 
...
Figure 5 (A, B, C, D) *(color score figure, full figure includes Mortality data (see Partial mortality Rmd))*
```{r}
...
# Pairs subset - Supplementary Table 6.
