...
summary(Month0_mcap) #all should be ~0 and are
anova(Month0_mcap) 

#Month1.5
Month1.5_mcap<-art(score~Site+B2015+Site:B2015, Mcap_1.5)  #using TagID as only random factor not PAIR
summary(Month1.5_mcap) #all should be ~0 and are
anova(Month1.5_mcap) 

#Month3
Month3_mcap<-art(score~Site+B2015+Site:B2015, Mcap_3)  #using TagID as only random factor not PAIR
summary(Month3_mcap) #all should be ~0 and are
anova(Month3_mcap)
...
#Month1.5
Month1.5_Pcomp<-art(score~Site+B2015+Site:B2015, Pcomp_1.5)  #using TagID as only random factor not PAIR
summary(Month1.5_Pcomp) #all should be ~0 and are
anova(Month1.5_Pcomp) 

#Month3
Month3_Pcomp<-art(score~Site+B2015+Site:B2015, Pcomp_3)  #using TagID as only random factor not PAIR
summary(Month3_Pcomp) #all should be ~0 and are
anova(Month3_Pcomp)

#Month4.5
Month4.5_Pcomp<-art(score~Site*B2015, Pcomp_4.5)  #TagID removed bc not repeated measures
summary(Month4.5_Pcomp) #all should be ~0 and are
...
#Month10
Month10_Pcomp<-art(score~Site+B2015+Site:B2015, Pcomp_10)  #using TagID as only random factor not PAIR
summary(Month10_Pcomp) #all should be ~0 and are
anova(Month10_Pcomp)

#Month18
Month18_Pcomp<-art(score~Site+B2015+Site:B2015, Pcomp_18)  #using TagID as only random factor not PAIR
summary(Month18_Pcomp) #all should be ~0 and are
anova(Month18_Pcomp)

#Month24
Month24_Pcomp<-art(score~Site+B2015+Site:B2015, Pcomp_24)  #using TagID as only random factor not PAIR
