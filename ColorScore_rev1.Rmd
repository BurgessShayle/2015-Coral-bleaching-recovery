...
#new table 2 models with mixed models (lmer)  AKA new Table 2
Mcap_df  full model
```{r}
#MONTH AS FACTOR
...
leveneTest(score~B2015*Site*month, Mcap_df) # do we do this?????
qqPlot(residuals(Mcap_df_mod))              # and this???
...
#TIME AS NUMERIC
Mcap_df_mod<-lmer(score~B2015*Site*time+(1|TagID), data=Mcap_df)
summary(Mcap_df_mod)
anova(Mcap_df_mod) #pvals

test1b<-emmeans(Mcap_df_mod, "time")
...
Pcomp_df - full model
```{r}
#pcomp  - time as numeric
Pcomp_df_mod<-lmer(score~B2015*Site*time+(1|TagID), data=Pcomp_df)
summary(Pcomp_df_mod)
anova(Pcomp_df_mod) #pvals

#pcomp  - month as factor
...
#Month0
Month0_mcap0<-aov(score~Site*B2015, Mcap_0)
summary(Month0_mcap0)

#Month1.5
Month1.5_mcap1.5<-aov(score~Site*B2015, Mcap_1.5)
summary(Month1.5_mcap1.5)

#Month3
Month3_mcap3<-aov(score~Site*B2015, Mcap_3)
summary(Month3_mcap3)

#Month4.5
Month4.5_mcap4.5<-aov(score~Site*B2015, Mcap_4.5)
summary(Month4.5_mcap4.5)

#Month6
Month6_mcap6<-aov(score~Site*B2015, Mcap_6)
summary(Month6_mcap6)

#Month10
Month10_mcap10<-aov(score~Site*B2015, Mcap_10)
summary(Month10_mcap10)

#Month18
Month18_mcap18<-aov(score~Site*B2015, Mcap_18)
summary(Month18_mcap18)

#Month24
Month24_mcap24<-aov(score~Site*B2015, Mcap_24)
...
#Month0
Month0_Pcomp0<-aov(score~Site*B2015, Pcomp_0)
summary(Month0_Pcomp0)

#Month1.5
Month1.5_Pcomp1.5<-aov(score~Site*B2015, Pcomp_1.5)
summary(Month1.5_Pcomp1.5)

#Month3
Month3_Pcomp3<-aov(score~Site*B2015, Pcomp_3)
summary(Month1.5_Pcomp3)

#Month4.5
Month4.5_Pcomp4.5<-aov(score~Site*B2015, Pcomp_4.5)
summary(Month4.5_Pcomp4.5)

#Month6
Month6_Pcomp6<-aov(score~Site*B2015, Pcomp_6)
summary(Month6_Pcomp6)

#Month10
Month10_Pcomp10<-aov(score~Site*B2015, Pcomp_10)
summary(Month10_Pcomp10)

#Month18
Month18_Pcomp18<-aov(score~Site*B2015, Pcomp_18)
summary(Month18_Pcomp18)

#Month24
Month24_Pcomp24<-aov(score~Site*B2015, Pcomp_24)
...
Mcap_b0<-subset(Mcap_df, month=="Month0")
Mcap_b0_mod1<-aov(score~Site*B2015, Mcap_b0)
summary(Mcap_b0_mod1)
TukeyHSD(Mcap_b0_mod1)
...
#Month0
dPpigPair0<-subset(DiffData_all_Pcomp, month =="Month0")          
dPpigPair0_mod1<-aov(diff~Site, dPpigPair0)
summary(dPpigPair0_mod1)
...
Pcomp diff ARTools (CODE not edited yet)
```{r}
DiffData_all_Pcomp<-subset(All_diff, Species=="Porites compressa")
