...
#load data
mData<-read.csv("/Users/shayle/Desktop/B_NB/DECIMALmortality_scores_percent_20191110_missingdataremoved.csv")
...
##subset 0-3 months
  m03<-subset(mALLData, month=="Month0" |month=="Month3")
      m03<-dcast(m03, Species+Site+Pair+B2015~month) # cast() 
  m03<-na.omit(m03) # remove the NA colums
   
#subset 3-6 months
m36<-subset(mALLData, month=="Month3" |month=="Month6")

      m36<-dcast(m36, Species+Site+Pair+B2015~month) # cast()
      m36<-na.omit(m36) # remove the NA colums 

#subset 0-1.5-3 months for pairs comparison 
m0153<-subset(mALLData, month=="Month0" |month=="Month1.5"|month=="Month3")

#subset 3-4.5-6 months for pairs comparison 
m3456<-subset(mALLData, month=="Month3" |month=="Month4.5"|month=="Month5")
 
#subset 0-1.5-3-4.5-6 months for pairs comparison 
m0153456<-subset(mALLData, month=="Month0"  |month=="Month1.5"|month=="Month3"|month=="Month4.5"|month=="Month6") 
```
...
*M. capitata* All
```{r}
Mcapmort03All<-subset(m0153, Species=="Montipora capitata")
Mcapmort06All<-subset(m0153456, Species=="Montipora capitata")
Mcapmort36All<-subset(m3456, Species=="Montipora capitata")

#0-3
Mcapmort03All_mod<-aov(score~month*Site*B2015, Mcapmort03All)
summary(Mcapmort03All_mod)
TukeyHSD(Mcapmort03All_mod)

#0-6
Mcapmort06All_mod<-aov(score~month*Site*B2015, Mcapmort06All)
summary(Mcapmort06All_mod)
TukeyHSD(Mcapmort06All_mod)
```

Table 3
*P. compressa*
```{r}
Pcompmort03All<-subset(m0153, Species=="Porites compressa")
Pcompmort06All<-subset(m0153456, Species=="Porites compressa")
Pcompmort36All<-subset(m3456, Species=="Porites compressa")

#0-3
Pcompmort03All_mod<-aov(score~month*Site*B2015, Pcompmort03All)
summary(Pcompmort03All_mod)
TukeyHSD(Pcompmort03All_mod)

#0-6
Pcompmort06All_mod<-aov(score~month*Site*B2015, Pcompmort06All)
summary(Pcompmort06All_mod)
TukeyHSD(Pcompmort06All_mod)
```

# Partial mortality rate 
Mean partial mortality rate at 0-3 months and 3-6 months. 
## 0-3 Months RATE
```{r}
## 1. 0-3 months
#Calc average rate per colony 0-3 months
m03$Rate03<-(((m03$Month3-m03$Month0)))
 ...
 *Montipora capiatata*  
```{r}
Mcap_mALLData<-subset(mALLData, Species=="Montipora capitata")   # pull out Mcap

#Month0
Mcap_m0<-subset(Mcap_mALLData, month=="Month0")
Mcap_m0_mod1<-aov(score~Site*B2015, Mcap_m0)
summary(Mcap_m0_mod1) 
TukeyHSD(Mcap_m0_mod1) 

# Month1.5
Mcap_m1_5<-subset(Mcap_mALLData, month=="Month1.5")
Mcap_m1_5_mod1<-aov(score~Site*B2015, Mcap_m1_5)
summary(Mcap_m1_5_mod1)
TukeyHSD(Mcap_m1_5_mod1)

#Month3
Mcap_m3<-subset(Mcap_mALLData, month=="Month3")
Mcap_m3_mod1<-aov(score~Site*B2015, Mcap_m3)
summary(Mcap_m3_mod1)
TukeyHSD(Mcap_m3_mod1)

#Month4.5
Mcap_m4_5<-subset(Mcap_mALLData, month=="Month4.5")
Mcap_m4_5_mod1<-aov(score~Site*B2015, Mcap_m4_5)
summary(Mcap_m4_5_mod1)
TukeyHSD(Mcap_m4_5_mod1)

#Month6
Mcap_m6<-subset(Mcap_mALLData, month=="Month6")
Mcap_m6_mod1<-aov(score~Site*B2015, Mcap_m6)
summary(Mcap_m6_mod1)
TukeyHSD(Mcap_m6_mod1)
```

*Porites compressa*  
SI Table 2 and SI Table 12
```{r}
Pcomp_mALLData<-subset(mALLData, Species=="Porites compressa")   # pull out Mcap

#Month0
Pcomp_m0<-subset(Pcomp_mALLData, month=="Month0")   
Pcomp_m0_mod1<-aov(score~Site*B2015, Pcomp_m0)
summary(Pcomp_m0_mod1)
TukeyHSD(Pcomp_m0_mod1)

#Month1.5
Pcomp_m1_5<-subset(Pcomp_mALLData, month=="Month1.5")   
Pcomp_m1_5_mod1<-aov(score~Site*B2015, Pcomp_m1_5)
summary(Pcomp_m1_5_mod1)
TukeyHSD(Pcomp_m1_5_mod1)

#Month3
Pcomp_m3<-subset(Pcomp_mALLData, month=="Month3")   
Pcomp_m3_mod1<-aov(score~Site*B2015, Pcomp_m3)
summary(Pcomp_m3_mod1)
TukeyHSD(Pcomp_m3_mod1)

#Month4.5
Pcomp_m4_5<-subset(Pcomp_mALLData, month=="Month4.5")   
Pcomp_m4_5_mod1<-aov(score~Site*B2015, Pcomp_m4_5)
summary(Pcomp_m4_5_mod1)
TukeyHSD(Pcomp_m4_5_mod1)

#Month6
Pcomp_m6<-subset(Pcomp_mALLData, month=="Month6")   
Pcomp_m6_mod1<-aov(score~Site*B2015, Pcomp_m6)
summary(Pcomp_m6_mod1)
TukeyHSD(Pcomp_m6_mod1)
```
...
```{r}
#subset Mcap
Mcap_m03<-subset(m03, Species=="Montipora capitata") #subset Mcap
#0-3 months
