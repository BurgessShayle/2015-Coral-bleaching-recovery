...
#write.csv(mALLmeans, "mALLmeansMORT.csv")
```
...
#mALLmeansPER #display table
#write.csv(mALLmeansPER, "meanMortpER.csv")
```
...
Mortality across all timepoints, df setup
```{r, results="hide", message=FALSE}
#Mcap
