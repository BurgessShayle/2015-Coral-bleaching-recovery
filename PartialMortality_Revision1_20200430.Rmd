...
anova(Mcap_m3_mod1)
  ...
  #conduct Tukey post hoc test 
      ...
      #letter display
      pairs(emm)
        #4,N - 4,Y    -0.3471 0.0676 77 -5.132  <.0001 
        #13,N - 13,Y  -0.0977 0.0685 77 -1.426  0.4873
...
McapRate03<-ggplot(data=m03means, aes(x=code, y=mean, group = code, color=B2015)) + #color by bleaching hist. 
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1,show.legend = FALSE)+
#  geom_point(aes(shape=B2015),fill="mediumblue", size=5)+
#  scale_shape_manual(values=c( 16,1))+
 ...
 #   ylim(0, 80) + #set Y limits
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
 # ggtitle("Outer Lagoon")+
          theme(plot.title = element_text(size=20,face = "bold",hjust = 0.5));McapRate03


McapRate36<-ggplot(data=m36means, aes(x=code, y=mean, group = code, color=B2015)) + #color by bleaching hist. 
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1,show.legend = FALSE)+
#  geom_point(aes(shape=B2015),fill="mediumblue", size=5)+
#  scale_shape_manual(values=c( 16,1))+
 ...
 #   ylim(0, 80) + #set Y limits
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
 # ggtitle("Outer Lagoon")+
          theme(plot.title = element_text(size=20,face = "bold",hjust = 0.5));McapRate36
...
PcompRate03<-ggplot(data=p03means, aes(x=code, y=mean, group = code, color=B2015)) + #color by bleaching hist. 
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1,show.legend = FALSE)+
#  geom_point(aes(shape=B2015),fill="mediumblue", size=5)+
#  scale_shape_manual(values=c( 16,1))+
 ...
 #   ylim(0, 80) + #set Y limits
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
 # ggtitle("Outer Lagoon")+
          theme(plot.title = element_text(size=20,face = "bold",hjust = 0.5));PcompRate03


PcompRate36<-ggplot(data=p36means, aes(x=code, y=mean, group = code, color=B2015)) + #color by bleaching hist. 
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1,show.legend = FALSE)+
#  geom_point(aes(shape=B2015),fill="mediumblue", size=5)+
#  scale_shape_manual(values=c( 16,1))+
 ...
 #   ylim(0, 80) + #set Y limits
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
 # ggtitle("Outer Lagoon")+
          theme(plot.title = element_text(size=20,face = "bold",hjust = 0.5));PcompRate36
...
```{r} 
#0-3 months
Mcap_m03rate<-lm(Rate~Site*B2015, Mcap_rate_03)
...
#3-6 months
Mcap_m36rate<-lm(Rate~Site*B2015, Mcap_rate_36)
...
```{r}
#0-3 months 
Pcomp_m03rate<-lm(Rate~Site*B2015, Pcomp_rate_03)
summary(Pcomp_m03rate)
anova(Pcomp_m03rate)

#3-6 months
Pcomp_m36rate<-lm(Rate~Site*B2015, Pcomp_rate_36)
